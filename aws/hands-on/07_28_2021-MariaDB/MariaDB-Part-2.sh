...
# Choose a database (mysql db) to work with. ⚠️ Caution: We have chosen mysql db as demo purposes, normally database mysql is 
#used by server itself, it shouldn't be changed or altered by the user.

...
```python
import json # degisiklikler icin json import ediyor
import boto3 # CLI benzer ama cok fazlasini python koduyla yapabiliriz

# boto3 S3 initialization
s3_client = boto3.client("s3")


def lambda_handler(event, context): # s3 buckete bir sey konulmasi == event
   destination_bucket_name = 'clarusway.destination.lambda' # bucket name girilecek

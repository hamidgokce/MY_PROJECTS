...
# SQL icin gerekli enviromentleri configure edecegiz https://flask-sqlalchemy.palletsprojects.com/en/2.x/config/
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///./email.db' # burada bir path tanimladik
...
drop_table = 'DROP TABLE IF EXISTS users;' # users isimli bir tablo olusturmak istiyoruz. Eger bu isimde bir tablo varsa silsin diyoruz (12-24 bir defa icra edilir
...
def insert_email(name,email): # fonksiyon tanimladik 2 degiskenli / email ekleyecegiz
    query = f""" 
